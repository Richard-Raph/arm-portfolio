import '../assets/css/StatBar.css';
import { useState, useEffect } from 'react';
import logo from '../assets/images/logo-fff.webp';
import { TbWifi, TbWifiOff } from 'react-icons/tb';
import { PiBatteryHighFill, PiBatteryFullFill, PiBatteryChargingFill } from 'react-icons/pi';
      ...
      <div className='stats'>
        ...
        {battery ? (
          isCharging ? (
            ...
            <PiBatteryHighFill color='#f46b5d' size={20} />
          ) : battery.level <= 0.5 ? (
            <PiBatteryFullFill color='#f9bd4e' size={20} />
          ) : (
